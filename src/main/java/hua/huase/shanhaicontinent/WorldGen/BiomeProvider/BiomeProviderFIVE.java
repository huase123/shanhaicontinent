...
import hua.huase.shanhaicontinent.WorldGen.layer.GenLayerTFBiomesFIVE;
...
public class BiomeProviderFIVE extends BiomeProviderBase {

	private final BiomeCacheMy mapCache;

	public BiomeProviderFIVE(World world) {
...
//		getBiomesToSpawnIn().add(biome);
	...
	private void makeLayers(long seed) {
		GenLayer biomes = new GenLayerTFBiomesFIVE(1L);
