...
import hua.huase.shanhaicontinent.WorldGen.layer.GenLayerTFBiomesSIX;
...
public class BiomeProviderSIX extends BiomeProviderBase {

	private final BiomeCacheMy mapCache;

	public BiomeProviderSIX(World world) {
...
//		getBiomesToSpawnIn().add(biome);
	...
	private void makeLayers(long seed) {
		GenLayer biomes = new GenLayerTFBiomesSIX(1L);
