...
import hua.huase.shanhaicontinent.WorldGen.layer.GenLayerTFBiomesTWO;
...
public class BiomeProviderTWO extends BiomeProviderBase {

	private final BiomeCacheMy mapCache;

	public BiomeProviderTWO(World world) {
...
//		getBiomesToSpawnIn().add(biome);
	...
	private void makeLayers(long seed) {
		GenLayer biomes = new GenLayerTFBiomesTWO(1L);
