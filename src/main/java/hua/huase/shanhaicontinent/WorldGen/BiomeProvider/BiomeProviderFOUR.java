...
import hua.huase.shanhaicontinent.WorldGen.layer.GenLayerTFBiomesFOUR;
...
public class BiomeProviderFOUR extends BiomeProviderBase {

	private final BiomeCacheMy mapCache;

	public BiomeProviderFOUR(World world) {
...
//		getBiomesToSpawnIn().add(biome);
	...
	private void makeLayers(long seed) {
		GenLayer biomes = new GenLayerTFBiomesFOUR(1L);
