...
import hua.huase.shanhaicontinent.WorldGen.layer.GenLayerTFBiomesONE;
...
public class BiomeProviderONE extends BiomeProviderBase {

	private final BiomeCacheMy mapCache;

	public BiomeProviderONE(World world) {
...
//		getBiomesToSpawnIn().add(biome);
	...
	private void makeLayers(long seed) {
		GenLayer biomes = new GenLayerTFBiomesONE(1L);
