...
public class MapGenCavesMy extends MapGenBase
{
    ...
    public void generate(World p_186125_1_, int p_186125_2_, int p_186125_3_, ChunkPrimer p_186125_4_) {
        int lvt_5_1_ = this.range;
        this.world = p_186125_1_;
        this.rand.setSeed(p_186125_1_.getSeed());
        long lvt_6_1_ = this.rand.nextLong();
        long lvt_8_1_ = this.rand.nextLong();

        this.recursiveGenerate(p_186125_1_, p_186125_2_, p_186125_3_, p_186125_2_, p_186125_3_, p_186125_4_);
        for(int lvt_10_1_ = p_186125_2_ - lvt_5_1_; lvt_10_1_ <= p_186125_2_ + lvt_5_1_; ++lvt_10_1_) {
            for(int lvt_11_1_ = p_186125_3_ - lvt_5_1_; lvt_11_1_ <= p_186125_3_ + lvt_5_1_; ++lvt_11_1_) {
                ...
                this.rand.setSeed(lvt_12_1_ ^ lvt_14_1_ ^ p_186125_1_.getSeed());
                this.recursiveGenerate(p_186125_1_, lvt_10_1_, lvt_11_1_, p_186125_2_, p_186125_3_, p_186125_4_);
            }
        }
...
//                                            IBlockState iblockstate2 = (IBlockState) MoreObjects.firstNonNull(p_180702_5_.getBlockState(j3, j2 + 1, i2), BLK_AIR);
                                            IBlockState iblockstate2 = BLK_AIR;
    ...
    {
        if (p_175793_1_.getBlock() == Blocks.AIR)
        {
            return true;
        }
     ...
     * @param state Pre-calculated index into block data
    ...
    protected void digBlock(ChunkPrimer data, int x, int y, int z, int chunkX, int chunkZ, boolean foundTop, IBlockState state, IBlockState up)
    {
        ...
        if (this.canReplaceBlock(state, up) || state.getBlock() == top.getBlock() || state.getBlock() == filler.getBlock())
        {
            if (y - 1 < 10)
            {
                data.setBlockState(x, y+60, z, BLK_SANDSTONE);
            }
            else if(y - 1 < 111)
            {
                data.setBlockState(x, y+60, z, BLK_RED_SANDSTONE);
