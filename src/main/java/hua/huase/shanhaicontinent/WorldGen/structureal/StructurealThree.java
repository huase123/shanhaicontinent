...
import hua.huase.shanhaicontinent.LootTablesHander;
...
public class StructurealThree implements IWorldGenerator {
    int distance;
    World world;
    public StructurealThree(){
        distance=18;
    }
    ...
    public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider) {
        ...
        BlockPos pos = new BlockPos(chunkX * 16, random.nextInt(30)+50 , chunkZ * 16);
//        for (IBlockState iblockstate = world.getBlockState(pos); !(iblockstate.getBlock().isAir(iblockstate, world, pos) && !iblockstate.getBlock().isLeaves(iblockstate, world, pos)) && pos.getY() < 100; iblockstate = world.getBlockState(pos))
//        {
//            pos = pos.up();
//        }
...
//        }
        ...
        {
            ((TileEntityChest)tileentity).setLootTable(LootTablesHander.GUFENGXIAOWU_CHESTS_DiYV, random.nextLong());
        }
