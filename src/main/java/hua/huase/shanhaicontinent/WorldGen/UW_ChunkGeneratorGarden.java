...
public class UW_ChunkGeneratorGarden implements IChunkGenerator {
    ...
    private MapGenBase caveGeneratorMy = new MapGenCavesMy();
    private MapGenStronghold strongholdGenerator = new MapGenStronghold();
    private MapGenVillage villageGenerator = new MapGenVillage();
    private MapGenEndCityMy mapGenEndCityMy = new MapGenEndCityMy(this);
...
//        flag = this.mapGenEndCityMy.generateStructure(this.world, this.rand, chunkpos);
//        if (this.mapFeaturesEnabled)
//        {
//            if (this.settings.useMineShafts)
//            {
