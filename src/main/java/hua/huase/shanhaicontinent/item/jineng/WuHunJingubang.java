...
public class WuHunJingubang extends Item {


    public WuHunJingubang(String name, CreativeTabs Tabs) {
        super();
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
        ...
        if (!worldIn.isRemote) {
            ...
            if(juexingWuHun(playerIn,"jingubang")){
                item.setCount(0);
            }
        }
...
//        list.remove(list.size()-1);
        list.add(net.minecraft.util.text.translation.I18n.translateToLocal("item.wuhunguoshi.jingubang.list0"));
    }
