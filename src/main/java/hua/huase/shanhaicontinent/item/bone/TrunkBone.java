...
public class TrunkBone extends Item implements IBauble
{

	public TrunkBone(String name, CreativeTabs Tabs) {
		super();
...
*/
	...
	public void onWornTick(ItemStack itemstack, EntityLivingBase player) {
		if (itemstack.getItemDamage()==0 && player.ticksExisted%99==0) {
			player.addPotionEffect(new PotionEffect(MobEffects.FIRE_RESISTANCE,100,1,true,true));
			player.addPotionEffect(new PotionEffect(MobEffects.WATER_BREATHING,100,1,true,true));
		}
	}
	@Override
