...
public class HeadBone extends Item implements IBauble
{

	public HeadBone(String name, CreativeTabs Tabs) {
		super();
...
*/
	...
	public void onWornTick(ItemStack itemstack, EntityLivingBase player) {
		if (itemstack.getItemDamage()==0 && player.ticksExisted%99==0) {
			player.addPotionEffect(new PotionEffect(MobEffects.NIGHT_VISION,600,0,true,true));
		}
	}
	@Override
