...
public class LeftLegBone extends Item implements IBauble
{

	public LeftLegBone(String name, CreativeTabs Tabs) {
		super();
...
*/
	...
	public void onWornTick(ItemStack itemstack, EntityLivingBase player) {
		if (itemstack.getItemDamage()==0 && player.ticksExisted%99==0) {
			player.addPotionEffect(new PotionEffect(MobEffects.SPEED,100,1,true,true));
		}
	}
	@Override
