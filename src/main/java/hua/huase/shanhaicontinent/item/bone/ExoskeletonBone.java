...
import hua.huase.shanhaicontinent.capability.*;
...
public class ExoskeletonBone extends Item implements IBauble
{

	public ExoskeletonBone(String name, CreativeTabs Tabs) {
		super();
...
*/
	...
	public void onWornTick(ItemStack itemstack, EntityLivingBase player) {
		if (itemstack.getItemDamage()==0 && player.ticksExisted%99==0) {
			player.addPotionEffect(new PotionEffect(MobEffects.ABSORPTION,100,1,true,true));
		}
	}
