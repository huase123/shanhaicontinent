...
public class RightLegBone extends Item implements IBauble
{

	public RightLegBone(String name, CreativeTabs Tabs) {
		super();
...
*/
	...
	public void onWornTick(ItemStack itemstack, EntityLivingBase player) {
		if (itemstack.getItemDamage()==0 && player.ticksExisted%99==0) {
			player.addPotionEffect(new PotionEffect(MobEffects.JUMP_BOOST,100,1,true,true));
		}
	}
	@Override
