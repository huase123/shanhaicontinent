...
import hua.huase.shanhaicontinent.capability.baubles.seedpacket.PacketHunhuanKaiguan;
...
public class HunhuanEntity extends Entity {
            ...
            if(STAGE%20==0){
                ...
                if (player==null){
                    if(STAGE!=0&&STAGE<340){
                        ...
                        playerTite.sendMessage(new TextComponentTranslation(net.minecraft.client.resources.I18n.format("message.hunhuan.list-1")));
                    }
                    kaiguan=false;
                    for (EntityPlayer entityPlayer : Collections.singletonList(playerTite)) {
                        if(entityPlayer!=null)
                    ...
                    if(STAGE==0){
                        player.sendMessage(new TextComponentTranslation(net.minecraft.client.resources.I18n.format("message.hunhuan.list0", nianxian) ));
                        viewPlayer= ++STAGE;
                        return;
                    }
                    ...
                    if(PlayerCapabilityApi.isXishouHunhuan((EntityPlayer) player)){
                        ...
                        if(v >=0){
                            ...
                            if(STAGE==100){
                                ...
                                player.sendMessage(new TextComponentTranslation(net.minecraft.client.resources.I18n.format("message.hunhuan.list1", nianxian / 100f)));
                                viewPlayer= ++STAGE;
                                return;
                            }
                            if(STAGE==160){
                                ...
                                playerCapability.setJingshenli(v);
                                NetworkRegistryHandler.PlayerListen.sendClientCustomPacket((EntityPlayer) player);
                                player.sendMessage(new TextComponentTranslation(net.minecraft.client.resources.I18n.format("message.hunhuan.list2", nianxian / 100f)));
                                viewPlayer= ++STAGE;
                                return;
                            }
                            if(STAGE==220){
                                ...
                                playerCapability.setJingshenli(v);
                                NetworkRegistryHandler.PlayerListen.sendClientCustomPacket((EntityPlayer) player);
                                player.sendMessage(new TextComponentTranslation(net.minecraft.client.resources.I18n.format("message.hunhuan.list3", nianxian / 100f)));
                                viewPlayer= ++STAGE;
                                return;
                            }
                            if(STAGE==280){
                                ...
                                playerCapability.setJingshenli(v);
                                NetworkRegistryHandler.PlayerListen.sendClientCustomPacket((EntityPlayer) player);
                                player.sendMessage(new TextComponentTranslation(net.minecraft.client.resources.I18n.format("message.hunhuan.list4", nianxian / 100f)));
                                viewPlayer= ++STAGE;
                                return;
                            }
                            if(STAGE==340){
    ...
    //								playerCapability.getMonsterCapabilityList().add(entity.getCapability(MONSTER_CAPABILITY, null));
                                    ...
                                    NetworkRegistryHandler.PlayerListen.sendClientCustomPacket((EntityPlayer) player);
                                    player.sendMessage(new TextComponentTranslation(net.minecraft.client.resources.I18n.format("message.hunhuan.sccuess", nianxian) ));
                                    viewPlayer= 0;
                                    kaiguan=false;
                                    for (EntityPlayer entityPlayer : Collections.singletonList(playerTite)) {
                                        if(entityPlayer!=null)
                                ...
                                player.sendMessage(new TextComponentTranslation(net.minecraft.client.resources.I18n.format("message.hunhuan.fail", nianxian)));
                            }
                            ...
                            if(STAGE==300) {
                                ...
                                NetworkRegistryHandler.PlayerListen.sendClientCustomPacket((EntityPlayer) player);
                                player.sendMessage(new TextComponentTranslation(net.minecraft.client.resources.I18n.format("message.hunhuan.list.false", jingshenli)));
                                ((EntityLivingBase)player).addPotionEffect(new PotionEffect(MobEffects.NAUSEA,200,0,true,true));
                            }
                        }
                        ...
                        if(STAGE%100==0) {
                            player.sendMessage(new TextComponentTranslation(net.minecraft.client.resources.I18n.format("message.hunhuan.list.no")));
                            viewPlayer= ++STAGE;
                            return;
                        }
                    }
