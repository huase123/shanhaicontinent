...
public class EntityWuHunHuangSNSL extends EntityThrowable {
    public static final String ID = "EntityWuHunHuangSNSL";
    public static final String NAME = ExampleMod.MODID + ".EntityWuHunHuangSNSL";
    ...
    public EntityWuHunHuangSNSL(World worldIn) {
        super(worldIn);
        this.boltVertex = this.rand.nextLong();
        this.setSize(3.0F, 1.4F);
    }

    public EntityWuHunHuangSNSL(World worldIn, EntityPlayer entityPlayer) {
