...
public class EntityWuHunHuangKPBS extends EntityThrowable {
    public static final String ID = "EntityWuHunHuangKPBS";
    public static final String NAME = ExampleMod.MODID + ".EntityWuHunHuangKPBS";
    ...
    public EntityWuHunHuangKPBS(World worldIn) {
        super(worldIn);
        this.setSize(3.0F, 1.4F);
    }

    public EntityWuHunHuangKPBS(World worldIn, EntityPlayer entityPlayer) {
