...
public class HunhuanEntityEntity extends Entity implements hua.huase.shanhaicontinent.entity.HunhuanEntity {
    private int existenceTime;
    private int livetime;
    private Player player;
    public HunhuanEntityEntity(EntityType<?> entityType, Level level) {
