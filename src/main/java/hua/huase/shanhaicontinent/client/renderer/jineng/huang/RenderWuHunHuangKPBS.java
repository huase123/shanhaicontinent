...
public class RenderWuHunHuangKPBS extends RenderEntity {
...
public RenderWuHunHuangKPBS(RenderManager renderManager) {
        super(renderManager);
    }
    ...
    public void doRender(Entity entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        bufferbuilder.pos(0, -1.5, 8).color(0.4F, 0.2F, 0.2F, 1f).endVertex();
        bufferbuilder.pos(0, 1.5, 8).color(0.4F, 0.2F, 0.2F, 1f).endVertex();
        bufferbuilder.pos(0, 1.5, 2).color(0.4F, 0.2F, 0.2F, 1f).endVertex();
        bufferbuilder.pos(0, -1.5, 2).color(0.4F, 0.2F, 0.2F, 1f).endVertex();

        bufferbuilder.pos(0, -1.5, 2).color(0.4F, 0.2F, 0.2F, 1f).endVertex();
        bufferbuilder.pos(0, 1.5, 2).color(0.4F, 0.2F, 0.2F, 1f).endVertex();
        bufferbuilder.pos(0, 0, 1).color(0.4F, 0.2F, 0.2F, 1f).endVertex();
        bufferbuilder.pos(0, 0, 1).color(0.4F, 0.2F, 0.2F, 1f).endVertex();
        tessellator.draw();
