...
public class PotionWuHunHuangLHBS extends Potion
{
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(ExampleMod.MODID + ":textures/potion/wuhunhuang/wuhunhuanglhbs.png");

    public PotionWuHunHuangLHBS()
    {
        super(false, 0x00ff00);
        this.setRegistryName(ExampleMod.MODID + ":wuhunhuanglhbs");
        this.setPotionName("effect." + ExampleMod.MODID + ".wuhunhuanglhbs");
