...
public class PotionWuqijnJDY extends Potion
{
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(ExampleMod.MODID + ":textures/potion/wuqijnjdy.png");

    public PotionWuqijnJDY()
    {
        super(false, 0xffffff);
        this.setRegistryName(ExampleMod.MODID + ":wuqijnjdy");
        this.setPotionName("effect." + ExampleMod.MODID + ".wuqijnjdy");
    ...
    public Multimap<String, AttributeModifier> Multimap(){
        ...
        multimap.clear();
        multimap.put(SharedMonsterAttributes.MOVEMENT_SPEED.getName(), new AttributeModifier(UUID.fromString("7107DE5E-7CE8-4030-940E-514C1F161118"), "Weapon modifier", 1.99, 2));
